...
<html lang="en">
  <head>
    ...
    <title>Laporan Aset | SIPATRIA - Petugas</title>
    <meta
                      ...
                      <table id="basic-datatables" class="display table table-striped table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-left"><?php echo htmlspecialchars($aset['nama_aset']); ?></td>
                          ...
                          <?php if($no == 1): ?>
                          <tr>
                            <td colspan="8" class="text-center">Tidak ada data aset yang sesuai dengan filter</td>
                          </tr>
                          <?php endif; ?>
                        </tbody>
                        <tfoot>
                          <tr>
                            <th colspan="7" style="text-align: right;">TOTAL NILAI:</th>
